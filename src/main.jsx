...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      },
      {
        ...
        loader: () => fetch('https://technology-and-electronics-server-98tlqjyw9-ashim-roys-projects.vercel.app/products')
      ...
      },
      {
        ...
        loader: ({params}) => fetch(`https://technology-and-electronics-server-98tlqjyw9-ashim-roys-projects.vercel.app/products/${params.id}`)
      ...
      },
      {
        ...
        loader: () => fetch('https://technology-and-electronics-server-98tlqjyw9-ashim-roys-projects.vercel.app/carts')
      }
